...
export default function BirthStatistics({
  ...
  const chartData = {
    labels: historicalData.map((d: any) => d.year),
    datasets: [
      {
        label: 'Crude Birth Rate',
        data: historicalData.map((d: any) => d.crudebirthRate),
      ...
      },
      {
        ...
        data: historicalData.map((d: any) => d.totalFertilityRate),
  ...
  return (
    <section id="birth-statistics" className="mb-12">

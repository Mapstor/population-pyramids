...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Raptive/AdThrive head code — restored inline in <head> so ads and
            bidders initialise before render (Raptive install guide). Byte-identical
            to origin/main. Microsoft Clarity stays on next/script in <body>. */}

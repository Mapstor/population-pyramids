  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        ...
        {/* AdThrive head tag — bootstraps the ad system. */}
        <Script id="adthrive-head" strategy="afterInteractive" data-no-optimize="1" data-cfasync="false">
          {`
            (function(w, d) {
        ...
        {/* AdThrive email detection — must run after adthrive bootstrap above. */}
        <Script id="adthrive-email-detect" strategy="afterInteractive">
          {`
        ...
        <Script id="adblock-recovery-gdpr" strategy="afterInteractive" dangerouslySetInnerHTML={{
        ...
        />
        <Script id="adblock-recovery-loader" strategy="afterInteractive" dangerouslySetInnerHTML={{
